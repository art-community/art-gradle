...
class ContextLogger(private val context: String, private val project: Project) {
    fun quiet(message: String) = project.log(message, context)
    fun success(message: String) = project.log(message, context)
    fun warning(message: String) = project.log(message, context)
    fun attention(message: String) = project.log(message, context)
    fun additional(message: String) = project.log(message, context)
