        ...
        GRAAL_CONFIGURATION_FILES.forEach { json ->
            resolve(CONFIGURATION).apply {
                ...
                val bytes = externalPlugin
                        .javaClass
                        .classLoader
                        .getResourceAsStream(GRAAL_BASE_RESOURCE_CONFIGURATION_PATH(configuration.native.graalJavaVersion, json))!!
                        .readBytes()
...
private fun Project.useUnixBuilder(configuration: ExecutableConfiguration, paths: GraalPaths) {
