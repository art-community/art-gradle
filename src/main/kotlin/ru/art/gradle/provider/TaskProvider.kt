...
import ru.art.gradle.constants.DefaultTasks.COMPILE_GATLING_SCALA
...
fun Project.compileGatlingScala() = tasks.getByPath(COMPILE_GATLING_SCALA) as ScalaCompile
