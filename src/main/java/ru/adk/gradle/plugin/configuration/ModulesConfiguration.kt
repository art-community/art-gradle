...
open class ModulesConfiguration @Inject constructor(val project: Project) {
    ...
    protected open fun applicationProtobufClient(dependencyModifiers: Array<out (dependency: Dependency) -> Unit> = emptyArray()) {
        addModule("application-protobuf-client", dependencyModifiers)
    }
    ...
    @Deprecated(message = "removed")
    protected open fun applicationProtobufServer(dependencyModifiers: Array<out (dependency: Dependency) -> Unit> = emptyArray()) {
        addModule("application-protobuf-server", dependencyModifiers)
    }
...
open class PublicModulesConfiguration @Inject constructor(project: Project) : ModulesConfiguration(project) {
    ...
    public override fun applicationProtobufClient(vararg dependencyModifiers: (dependency: Dependency) -> Unit) {
        super.applicationProtobufClient(dependencyModifiers)
    }
    ...
    public override fun applicationProtobufServer(vararg dependencyModifiers: (dependency: Dependency) -> Unit) {
        super.applicationProtobufServer(dependencyModifiers)
    }
