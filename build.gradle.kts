...
dependencies {
    ...
    compileOnly("org.gradle", "gradle-kotlin-dsl", "6.1.1")
    compileOnly("org.jetbrains.kotlinx", "kotlinx-metadata-jvm", "0.2.0")
    compileOnly("io.github.art", "application-generator", "1+")

    embedded("org.eclipse.jgit", "org.eclipse.jgit", "5.3.1.201904271842-r")
    embedded("me.champeau.gradle", "jmh-gradle-plugin", "0.5.+")
    embedded("org.jetbrains.kotlin", "kotlin-gradle-plugin", "1.4.10")
    embedded("org.jetbrains.kotlin", "kotlin-compiler-embeddable", "1.4.10")
